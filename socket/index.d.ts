...
declare module "socket:service-worker/database" {
  ...
  export function open(
    name: string,
    options?: (DatabaseOptions | undefiend) | null
  ): Promise<Database>;
  /**
  ...
  export class Database extends EventTarget {
    ...
    get(
      key: string,
      options?: (DatabaseGetOptions | undefiend) | null
    ...
    put(
      key: string,
      value: any,
      options?: (DatabasePutOptions | undefiend) | null
    ): Promise<any>;
    /**
    ...
    delete(
      key: string,
      options?: (DatabaseDeleteOptions | undefiend) | null
    ): Promise<any>;
    /**
     * Gets a "readonly" value by `key` in the `Database` object storage.
     * @param {string} key
     ...
     */
    entries(
      options?: (DatabaseEntriesOptions | undefiend) | null
    ): Promise<object | object[] | null>;
    #private;
  }
  namespace _default {
