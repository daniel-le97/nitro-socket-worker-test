globalThis =  globalThis || self || global || {};globalThis._importMeta_={url:"file:///_entry.js",env:{}};const assets$1 = {
  "/favicon.ico": {
    "type": "image/vnd.microsoft.icon",
    "etag": "\"10be-n8egyE9tcb7sKGr/pYCaQ4uWqxI\"",
    "mtime": "2024-04-11T04:18:14.608Z",
    "size": 4286,
    "path": "../favicon.ico"
  },
  "/icon.png": {
    "type": "image/png",
    "etag": "\"2a92f-L9QBuHVOV1R/hc3pvJXZasbPtQ8\"",
    "mtime": "2024-04-11T04:18:14.609Z",
    "size": 174383,
    "path": "../icon.png"
  }
};
...
const _lazy_0BP6T4 = () => Promise.resolve().then(function () { return index$5; });
const _lazy_9Ar1TE = () => Promise.resolve().then(function () { return index$3; });
const _lazy_6jhsA2 = () => Promise.resolve().then(function () { return dogs$1; });
const _lazy_ilurHN = () => Promise.resolve().then(function () { return index$1; });

const handlers = [
  { route: '/api/dogs', handler: _lazy_0BP6T4, lazy: true, middleware: false, method: undefined },
  { route: '/api', handler: _lazy_9Ar1TE, lazy: true, middleware: false, method: undefined },
  { route: '/dogs', handler: _lazy_6jhsA2, lazy: true, middleware: false, method: undefined },
  { route: '/', handler: _lazy_ilurHN, lazy: true, middleware: false, method: undefined }
];
...
const index$4 = eventHandler((event) => {
  return "dogs";
});
...
const index$2 = eventHandler((event) => {
...
const dogs = eventHandler((event) => {
  return "hello from dogs.ts!";
});

const dogs$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: dogs
}, Symbol.toStringTag, { value: 'Module' }));
